...
@section('content')
    ...
    <form method="get" class="admin-filter-bar">
        <select id="report-participation-college" name="college_id" class="admin-input min-w-[10rem] !mt-0">
        ...
        <select id="report-participation-department" name="department_id" class="admin-input min-w-[10rem] !mt-0">
    ...
    @push('scripts')
        @include('partials.admin-college-department-filter', [
            ...
            'collegeElementId' => 'report-participation-college',
            'departmentElementId' => 'report-participation-department',
