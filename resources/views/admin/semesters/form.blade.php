@extends('layouts.app')
@section('content')
    <h1 class="mb-6 text-2xl font-bold tracking-tight text-slate-900">{{ __('nav.semesters') }}</h1>
    <form method="post" action="{{ $item->exists ? route('admin.semesters.update', $item) : route('admin.semesters.store') }}" class="admin-form-panel">
